...
import { Bot, Cpu, Zap, AlertCircle } from "lucide-react"
...
export function filterAgentsByCapability(agents: Agent[], capability: string): Agent[] {
  ...
  return agents.filter(agent => 
    agent.capabilities?.includes(capability) || false
  )
}
...
export interface CompactAgentSelectorProps extends Omit<AgentSelectorProps, "showStatus" | "showModel"> {
