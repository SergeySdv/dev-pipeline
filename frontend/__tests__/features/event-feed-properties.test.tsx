...
const eventTypeFilterArbitrary = fc.oneof(
  fc.constant('all'),
  eventTypeArbitrary
)
    ...
    it('should correctly identify protocol links for any event', () => {
      fc.assert(
        fc.property(eventArbitrary, (event) => {
          ...
          const expectedHasLink = typeof event.protocol_run_id === 'number' && event.protocol_run_id !== null
