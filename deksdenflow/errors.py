...
class DeksdenflowError(RuntimeError):
    """
...
class ValidationError(DeksdenflowError):
...
class ConfigError(DeksdenflowError):
...
class CodexCommandError(DeksdenflowError):
    """Raised when Codex execution fails."""

    category = "codex"


class GitCommandError(DeksdenflowError):
    """Raised when git commands fail."""

    category = "git"


class CITriggerError(DeksdenflowError):
