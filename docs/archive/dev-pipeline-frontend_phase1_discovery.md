# Archived: `dev-pipeline-frontend` discovery notes

This document is kept for historical context. The active web console lives in `frontend/` and is served by the TasksGodzilla API at `/console`.
