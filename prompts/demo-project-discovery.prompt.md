...
- `specs/discovery/_runtime/DISCOVERY.md`: languages/frameworks, build/test tools, demo-specific features, dependencies, configuration, test data/fixtures, example usage patterns.
- `specs/discovery/_runtime/ARCHITECTURE.md`: demo system overview (components, example flows, key demonstration points, testing infrastructure, documentation structure).
- `specs/discovery/_runtime/API_REFERENCE.md`: demo endpoints/commands with clear examples, sample data, expected outputs for demonstration purposes.
- `specs/discovery/_runtime/CI_NOTES.md`: demo CI setup, testing commands, validation steps, and any demo-specific requirements.
...
5) Summaries: list demo setup requirements, missing documentation, and improvement suggestions in `specs/discovery/_runtime/CI_NOTES.md`.